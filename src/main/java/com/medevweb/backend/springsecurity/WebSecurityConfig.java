  ...
  SecurityFilterChain web(HttpSecurity http) throws Exception  {
      http
              ...
              .authorizeHttpRequests((authorize) -> authorize
            		  .requestMatchers(HttpMethod.GET, "/api/clients","/api/clients/page/**", "/api/uploads/img/**", "/images/**").permitAll()
            		  .requestMatchers("/api/authenticate").permitAll()
            		  .requestMatchers("/api/clients/{id}").permitAll()
            		  .requestMatchers("/api/bills/**").permitAll()
//            .antMatchers("/get-all-client/**").hasRole("ADMIN")
    ...
    /*
     * En los controllers agregar @Secured("ROLE_ADMIN") o bien @Secured({"ROLE_ADMIN"}) o @Secured({"ROLE_USER", "ROLE_ADMIN"})
     * para indicar que tipo de rol debe tener el usuario para acceder al endpoint
     * */
    /*
    http
